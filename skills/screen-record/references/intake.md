...
10. **ต้องการเสียงบรรยายในคลิปหรือไม่ ถ้าต้องการ เป็นภาษาไทยหรืออังกฤษ** *(ต้องถาม — ตัวเลือก:
    **ไม่มีเสียง / ภาษาไทย / ภาษาอังกฤษ**; มี profile ให้แสดงค่าที่เคยตอบแล้วขอ reconfirm)*
10.1 **ถ้ามีเสียง — ต้องการเสียงผู้ชายหรือผู้หญิง** *(ต้องถาม — ห้ามเลือกให้เอง)*

    | ภาษา | ผู้ชาย | ผู้หญิง |
    |---|---|---|
    | ไทย | `th-TH-NiwatNeural` | `th-TH-PremwadeeNeural` |
    | อังกฤษ | `en-US-GuyNeural` | `en-US-AriaNeural` |

    - ทุกเสียงเป็น **neural** พูดเป็นธรรมชาติแบบผู้บรรยายมืออาชีพ ไม่ใช่เสียงสังเคราะห์แข็ง ๆ
      *(macOS `say` ใช้ไม่ได้ — เสียงไทยมีตัวเดียวและฟังออกว่าเป็นเครื่อง)*
    ...
    - **โทนเสียง** — ถามด้วยเสมอ (มีค่าเริ่มต้นให้ยืนยัน):
      `podcast` คุยกับคนฟัง ไม่รีบ **เว้นจังหวะยาวที่สุด — คลิปที่คนดูจนจบ** ·
      `presenter` สุภาพเป็นทางการ **ค่าเริ่มต้นสำหรับงานส่งลูกค้า** · `lively` กระฉับกระเฉง ·
      `conversational` คุยกับคนดู · `calm` สงบนุ่ม · `narrator` เล่าเรื่องทุ้มช้า ·
      `professional` · `warm` · `soft` · `upbeat` · `documentary`
      *(ไทยมี 2 เสียงเท่านั้น โทนจึงคือการปรับความเร็ว/ความทุ้ม/ความดัง ไม่ใช่เปลี่ยนคนพูด)*
