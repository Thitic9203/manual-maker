...
## D. ค่าที่เหลือ — *มี default ถามรวบได้*
...
| ข้อ | คำถาม | Default |
|---|---|---|
| 10 | **ชื่อไฟล์** ต่อคลิป | ชื่อจากแหล่ง เช่น `TC_01` → `TC_01.mp4` (ASCII, ไม่มีช่องว่าง) |
| 11 | **ความละเอียด / คุณภาพ** | 1920×1080 · deviceScaleFactor 2 · H.264 CRF 20 preset slow (ดู `video-spec.md`) |
| 12 | **ภาพนิ่งประกอบ** | เก็บ 1 ภาพต่อจุดที่ต้องพิสูจน์ผลลัพธ์ (`expect`) — ภาพนิ่งไม่มีลูกศรเมาส์ |
| 13 | **ลูกศรเมาส์ + พิมพ์ทีละตัว** | เปิด — คลิปดูเหมือนคนใช้เองแล้วอัดจอเอง (ปิดได้ถ้าต้องการคลิปนิ่ง ๆ) |
