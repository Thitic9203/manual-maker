...
6. **ข้อมูลสำหรับอัดหน้าจอนำมาจากไหน** — ไฟล์คู่มือ · รายการ test case (ชีต/ลิงก์ + TC ID) · เอกสารสเปก
   (PRD / Confluence / Figma) *(ต้องถาม — ต้องได้ **ไฟล์หรือลิงก์จริง**)*

   🔴 **คำถามคือ "ข้อมูลมาจากไหน" ไม่ใช่ "อยากอัดเรื่องอะไร"** — เรื่องที่จะอัดเป็นสิ่งที่ *อ่านออกมาได้จากแหล่ง*
   ไม่ใช่สิ่งที่ผู้ใช้ต้องนั่งบรรยายให้ฟัง *(บทเรียน 2026-08-18: ถามว่า "อัดเรื่องอะไร" ผู้ใช้ตีกลับทันที)*

   🔴 **ห้ามมีตัวเลือก "ไม่มีไฟล์ — บอกขั้นตอนเอง"** — ตัวเลือกนั้นไม่มีประโยชน์และเปิดทางให้คลิปถูกอัดจาก
   ความจำของ AI. ไม่มีแหล่ง = **ยังเริ่มไม่ได้** → บอกผู้ใช้ตรงๆ ว่าต้องมีไฟล์/ลิงก์ก่อน แล้วรอ
   *(ผู้ใช้จะพิมพ์ขั้นตอนมาเองก็ได้ แต่ต้องเป็นสิ่งที่ผู้ใช้ยื่นมา ไม่ใช่ตัวเลือกที่เราหยิบยื่นให้)*

   - **ได้แหล่งมาแล้ว** → เปิดอ่าน แล้ว **ดึงรายการสิ่งที่จะอัดออกมาเป็นข้อ ๆ พร้อมเลข/ชื่อจากแหล่งนั้น** เอาไป
     แสดงใน Confirmation Gate ให้ผู้ใช้ตรวจ. ทุกขั้นตอนในคลิปต้องสืบกลับไปที่แหล่งนี้ได้ —
     **ห้ามเติมขั้นตอนที่แหล่งไม่มี** และ **ห้ามข้ามขั้นตอนที่แหล่งมี**.
   - **ผู้ใช้พิมพ์ขั้นตอนมาเองในแชต** → ถือเป็นแหล่ง แต่ต้อง **อ่านกลับให้ยืนยันทั้งชุดก่อนอัด** แล้วบันทึกไว้
     ในสรุปของรอบนี้.
