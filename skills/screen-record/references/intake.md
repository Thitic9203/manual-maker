...
| 11 | **ภาพนิ่งประกอบ** | เก็บ 1 ภาพต่อจุดที่ต้องพิสูจน์ผลลัพธ์ (`expect`) |
| 12 | **ปลายทางหลังอัด** | ไม่อัปโหลด — ส่งไฟล์ในเครื่อง (ถ้าต้องขึ้น Drive/Jira/Confluence ให้ระบุ) |
...
| ชื่อไฟล์ + ที่เก็บ | … |
| คุณภาพวิดีโอ | 1920×1080 · DSF 2 · H.264 CRF 20 · ภาพเป็นหน้าจอระบบล้วน ไม่มีแถบ/ข้อความใดวาดทับ |
