...
```json
{
  "recording": {
    ...
    "narration": { "enabled": true, "lang": "th", "voice": "th-TH-NiwatNeural" },
...
10. **ต้องการเสียงบรรยายในคลิปหรือไม่ ถ้าต้องการ เป็นภาษาไทยหรืออังกฤษ** *(ต้องถาม — ตัวเลือก:
    **ไม่มีเสียง / ภาษาไทย / ภาษาอังกฤษ**; มี profile ให้แสดงค่าที่เคยตอบแล้วขอ reconfirm)*
    - เสียงที่ใช้เป็น **เสียงผู้ชาย neural** — ไทย `th-TH-NiwatNeural` · อังกฤษ `en-US-GuyNeural`
      พูดเป็นธรรมชาติแบบผู้บรรยายมืออาชีพ ไม่ใช่เสียงสังเคราะห์แข็ง ๆ *(macOS `say` ใช้ไม่ได้ —
      เสียงไทยมีตัวเดียวเป็นผู้หญิงและฟังออกว่าเป็นเครื่อง)*
...
| อัปโหลดต่อหรือไม่ | … |
| **เสียงบรรยาย** | ไม่มี / ไทย / อังกฤษ — ถ้ามี ระบุเสียงที่ใช้ + **แนบบทบรรยายทุกบรรทัดให้ตรวจ** |
