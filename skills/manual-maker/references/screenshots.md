...
{"sections": {"2.1": {"steps": 7, "circles": [
   {"n": 1, "file": "02-1-01.png", "x": 123, "y": 456, "label": "เมนูตารางสอน"}
]}}}
```
...
| `circles[].label` | เป้าที่วงชี้ เขียนด้วยคำที่ระบบใช้จริง เช่น `"ปุ่มบันทึก"` |

`label` ไม่ใช่ของประดับ — สคริปต์พิสูจน์ได้แค่ว่า *วงมีอยู่ตรงพิกัดนั้นจริง* **ไม่ได้พิสูจน์ว่าวงชี้ถูกปุ่ม**
คนรีวิวใช้ `label` เทียบกับข้อความขั้นตอนเพื่อตัดสินข้อนั้น จึงต้องเขียนให้ตรงกับสิ่งที่วงทับอยู่จริง
